...
const SUGGESTED_QUESTIONS = [
  ...
  "Find our sweetest messages",
  "What were we talking about last month?",
  "Summarize our recent conversations",
  "Find messages about our plans",
];
...
export function AppSidebar({ analysisId, chatName, ...props }: AppSidebarProps) {
  const { messages, sendMessage, status, error } = useChat({
    id: analysisId,
    transport: new DefaultChatTransport({
      api: `/api/analysis/${analysisId}/chat`,
    }),
  });
      ...
      <SidebarContent className="flex flex-col h-full">
              ...
              <div className="flex-1 flex flex-col items-center justify-center space-y-6">
                <div className="text-center space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground max-w-[350px] mx-auto">
                    I can help you find messages, summarize conversations,
                    and explore your chat history.
                  </p>
                </div>
        ...
        <div className="p-4 shrink-0">
          <ChatInput
            ...
            isLoading={isLoading}
            placeholder={chatName ? `Ask me anything about ${chatName}...` : "Ask me anything about this chat..."}
          />
        </div>
      </SidebarContent>
    </Sidebar>
